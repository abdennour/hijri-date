...
var HijriDate = function () {
  ...
  _createClass(HijriDate, [{
    ...
    value: function subtractDays(days) {
      ...
      Array.from({ length: days }, function (v, k) {
        return k + 1;
      }).forEach(function (i) {
    ...
    key: 'is',
    value: function is() {
      //  return [this.year, this.month, this.date].every((field, i) => arguments[] )
    }
  }, {
    key: 'valueOf',
...
HijriDate.locales = { ar: _locales.ar, en: _locales.en };
...
var en = exports.en = {
  ...
  monthNames: ["Muha", "Saf", "Rab1", "Rab2", "Jumd1", "Jumd2", "Rajb", "Shbn", "Shwl", "Oct", "Qada", "Hija", "Muharram", "Safar", "Rabi'ul Awwal", "Rabi'ul Akhir", "Jumadal Ula", "Jumadal Akhira", "Rajab", "Sha'ban", "Ramadan", "Shawwal", "Dhul Qa'ada", "Dhul Hijja"]
};
